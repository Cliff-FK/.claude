...
- **Gating de licence / checkout / entitlements** (qui a le droit, débloquer après achat) → la plateforme de facturation/licence du projet (gater le code premium sur le droit d'usage effectif de la licence, pas sur un simple statut « a payé un jour »).
