...
```json
{
  ...
  "query": "Trop de gens annulent leur abo Pro de mon plugin. Conçois un flux d'annulation qui maximise la rétention, et donne-moi un chiffre concret de gain pour convaincre mon associé.",
  "expected_behavior": [
...
```json
{
  ...
  "expected_behavior": [
    "Distingue : carte refusée = churn INVOLONTAIRE = dunning (J+1/J+3/J+5) → délègue à la plateforme de facturation/licence du projet, hors de ce flux",
