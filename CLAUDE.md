...
- Code moderne, minimaliste, performant. Corriger la **cause profonde**, jamais rustiner. Tests unitaires à chaque fin d'étape.
...
- **Vérifier que l'action a eu lieu avant de juger son effet** (mesurer timestamp/log/état) : un « save » qui n'a pas marqué l'état dirty n'a rien déclenché.
